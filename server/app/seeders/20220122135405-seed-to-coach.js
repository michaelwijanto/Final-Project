      ...
      [
        {
          ...
          age: "20",
          bio: "`Behind every great athlete is a masterful coach that inspires the athlete to evolve into the strongest performer they can become.` Cathy Engelbert ",
          description:
        ...
        },
        {
          ...
          age: "24",
          bio: "`Gaya hidup sehat bukanlah barang yang bisa dibeli, tapi kebiasaan yang harus Anda lakukan secara rutin.` Denny Santoso",
          description:
        ...
        },
        {
          ...
          age: "23",
          bio: "`If when you look in the mirror you don't see the perfect version of yourself, you better see the hardest working version of yourself.` Chris Bumstead",
          description:
        ...
        },
        {
          ...
          age: "21",
          bio: "`Ketimbang kita berfokus dalam hal ini memuja-muji kehebatan dari sebuah kesakitan, kenapa gak kita berfokus memuja-muji kehebatan dari sebuah badan.` Ade Rai",
          description:
        ...
        },
        {
          ...
          age: "22",
          bio: "`Everybody wants to be a bodybuilder, but don't nobody wanna lift  no heavy ass weight.` Ronnie Coleman",
